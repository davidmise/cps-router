          ...
          <div class="p-1">
            <a href="javascript:;" class="dropdown-item d-flex align-items-center py-2">
              <div class="wd-30 ht-30 d-flex align-items-center justify-content-center bg-primary rounded-circle me-3">
                <i class="bi bi-gift" data-feather="gift"></i>
              </div>
        ...
        <div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
          ...
          <ul class="list-unstyled p-1">
            <li class="dropdown-item py-2">
              <RouterLink to="/profile" class="text-body ms-0">
                <i class="bi bi-person icon-md" data-feather="user"></i>
                <span>Profile</span>
              </RouterLink>
            </li>
            <li class="dropdown-item py-2">
              <a href="javascript:;" class="text-body ms-0">
                <i class="bi bi-pencil-square icon-md" data-feather="edit"></i>
            ...
            <li class="dropdown-item py-2">
              <a href="javascript:;" class="text-body ms-0">
                <i class="bi bi-repeat icon-md" data-feather="repeat"></i>
                <span>Switch User</span>
              </a>
            </li>
            <li class="dropdown-item py-2">
              <a href="javascript:;" class="text-body ms-0">
                <i class="bi bi-box-arrow-right icon-md" data-feather="log-out"></i>
